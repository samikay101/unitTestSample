...
namespace MyLogicApp.Tests
{
    ...
    public class MyLogicAppTestV2
    {
        ...
        /// </summary>
        [TestMethod]
        public async Task sampleWorkflow_MyLogicAppTestV2_ExecuteWorkflow_SUCCESS_Sample1()
        {
            // PREPARE Mock
        ...
        /// </summary>
        [TestMethod]
        public async Task sampleWorkflow_MyLogicAppTestV2_ExecuteWorkflow_SUCCESS_Sample2()
        {
            // PREPARE
            // Generate mock trigger data.
            var triggerMockOutput = new WhenAHTTPRequestIsReceivedTriggerOutput();
